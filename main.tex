...
\copyrightyear{2020} % add one to year if document submitted in Dec.
...
\include{ParkerLongcope2017/ParkerLongcope2017}
\include{MCOR_Paper/ParkerKankelborg2018}
\include{ESIS_Mission/ESIS_Mission}
\include{conclusion}
...
\bibliography{PL2017,ParkerKankelborg2018} % Bibliography.  Add your .bib file(s) here
...
\appendix
\include{ESIS_Assembly/ESIS_Assembly}
%\include{appendixb}
